...
export const HomePage: React.FC = () => {
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Button variant="outline" size="lg" className="rounded-full px-8 h-14 text-lg bg-white" onClick={() => setShowGallery(true)}>
                        View Templates
                    </Button>
                </div>
        ...
        {showGallery && <TemplateGalleryModal onClose={() => setShowGallery(false)} />}
        </>
    );
};
